export default function About() {
  return (
    <div className="max-w-6x1 mx-5 mb-5 space-y-4">
      <h1 className="text-2x1 font-medium text-amber-600">About</h1>
      <p>
      ...
      <p>
        Our website is designed t vide you with a comprehensive database of
      ...
      <p>
        ...
        world of cinema. Thar you for visiting our website and we hope you enjoy
        your time bro through our movie database. If you have any feedback or
